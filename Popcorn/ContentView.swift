                ...
                if selectedTab == .popular {
                    ScrollView(showsIndicators: false) {
                        if nowPlayingStatePopular.movies != nil {
                            MovieGridView(movies: nowPlayingStatePopular.movies!, numberOfRows: 2, useEndText: true, navTitle: "Popular")
                        }
                    }
                    .refreshable {
                ...
                if selectedTab == .essentials {
                    ScrollView(showsIndicators: false) {
                        if nowPlayingStateEssentials.movies != nil {
                            MovieGridView(movies: nowPlayingStateEssentials.movies!, numberOfRows: 2, useEndText: true, navTitle: "Upcoming")
                        }
                    }
                    .refreshable {
